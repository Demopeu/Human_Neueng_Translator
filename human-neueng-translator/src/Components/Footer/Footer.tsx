        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.links}>
            ...
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                openModal('의견제안', '파파고 서비스에 대한 의견이나 제안사항이 있으시면 여기에 작성해주세요. 여러분의 소중한 의견이 서비스 개선에 큰 도움이 됩니다.');
              }}
            >
              의견제안
            </a>
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                openModal('준수사항', '파파고 서비스 이용시 다음과 같은 사항을 준수해야 합니다: 불법 콘텐츠 번역 금지, 대량 자동화 번역 제한, 서비스 남용 금지 등');
              }}
            >
              준수사항
            </a>
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                openModal('품질 개선 동의', '파파고 서비스의 품질 향상을 위해 사용자가 입력한 텍스트와 번역 결과가 시스템 개선에 활용될 수 있습니다. 개인정보가 포함된 내용은 입력하지 않는 것을 권장합니다.');
              }}
            >
              품질 개선 동의
            </a>
